...
return [
    'content_logging' => [
        'stripped_text' => env('MAILGUN_WEBHOOKS_CONTENT_LOG_STRIP_TEXT', true),
        'stripped_html' => env('MAILGUN_WEBHOOKS_CONTENT_LOG_STRIP_HTML', true),
        'body_html' => env('MAILGUN_WEBHOOKS_CONTENT_LOG_BODY_HTML', true),
        'body_plain' => env('MAILGUN_WEBHOOKS_CONTENT_LOG_BODY_PLAIN', true),
    ],
